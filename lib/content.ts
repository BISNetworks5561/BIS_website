...
export const concerns = {
  ...
  items: [
    {
      q: "PC를 늘렸더니 인터넷이 느려지고 요금이 올랐어요",
      a: "가정용 회선은 단말 수에 제한이 있어 회선을 늘릴수록 요금도 늘어납니다. 오피스넷은 PC 대수 무제한, 추가 요금 0원입니다.",
    },
    {
...
export const pricing = {
  ...
  cta: "이 요금으로 상담받기",
  /** 요금표 하단 안내사항 (LG U+ 오피스넷 안내 기준) */
  notes: {
    staticIp: "고정IP는 유동IP 1개와 필수로 사용해야 하고, 한 회선에 최대 20개까지 사용할 수 있어요.",
    staticIpWhenTitle: "이럴 때 고정IP가 꼭 필요해요.",
    staticIpWhen: [
      "외부에서 사내 서버 · NAS(파일공유시스템) 접속이 지속적으로 필요할 때",
      "본사/협력사/클라우드/보안 시스템에서 ‘접속 허용된 (화이트 리스트) 지정 IP’로만 접속 해야할 때",
      "내부에 설치된 시스템·장비(CCTV/출입통제/POS/키오스크 등)를 외부에서 관제·유지보수해야 할 때",
    ],
    relocation: "개통 후 인터넷을 다른 주소지로 이전 설치하려면 회선에서 사용 중인 IP 전체를 이전해야 해요.",
  },
};
...
export const trust = {
  ...
  subtitle: "신뢰 지표 · 수상",
  points: [
    "LG U+ 기업통신상품 공식 판매센터 · 기업통신 전문 상담",
