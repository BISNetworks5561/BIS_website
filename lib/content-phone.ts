...
export const phoneHero = {
  ...
  bullets: ["기존 번호 그대로 사용", "U+ 가입자 간 무료 통화", "IP-520GA 전화기 단말 지원", "통화연결음, ARS 등 적용 가능"],
  primaryCta: "무료 상담 신청",
  secondaryCta: "전화 상담",
...
export const phoneBenefits = {
  ...
  subtitle: "가입 혜택",
  items: [
    { icon: "phone", title: "IP-520GA 전화기 단말 지원", desc: "컬러 LCD · 단축 60개 · 기가 지원 단말을 회선 수만큼 지원해 드립니다." },
...
export const phoneDetail = {
  ...
  device: {
    ...
    specs: [
      ...
      { k: "제공 조건", v: "단말 지원 (약정 기준)" },
    ],
    others: [
      { model: "HYC-P1200L", desc: "2.8인치 LCD · 전화번호부 2,000개", price: "단말 지원" },
...
export const phonePricingCopy = {
  ...
  notes: [
    ...
    "설치비와 번호이동 수수료는 BIS네트웍스 가입 시 지원됩니다.",
